...
\begin{versionhistory}
  ...
  \vhEntry{1.2}{2017/02/19}{boerpb}{added setLanguagePreference to person, reworked activities, moved getDeviceId to push, added deprecation warning to getAuthToken}
\end{versionhistory}
